...
library(gt)       # provides gt(), fmt_number(), tab_header(), cols_label()
...
# Tukey Honestly Significant Difference test suggests that the 5 point difference separating the LOW and moderate brokering groups is statistically significant
...
# Create a wide table for the ANOVA demonstration.
...
# Add a row containing each group's mean.
...
# Add labels for the 10 cases and the means row.
