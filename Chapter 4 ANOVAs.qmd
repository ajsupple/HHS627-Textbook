...
- Effect sizes quantify the magnitude of group differences. 31b8e172-b470-440e-83d8-e6b185028602::31b8e172-b470-440e-83d8-e6b185028602
...
- gives a global F, needs follow up posthoc tests for group-by-group comparisons

- main X or IV is a *factor* variable, typically nominal in nature

## ANOVAs with multiple factors

Now there are multiple X variables. Often the goal is to assess for an interaction effect

Take for example:

- Researchers want to examine an outdoor ropes course for adults who were victims of abuse as children

- 40 adults (20 male, 20 female) complete an outdoor ropes course and are given a pre-test and post-test score on self-efficacy

- 40 adults (20 male, 20 female) who were not part of the program, but also victims of abuse as children were assessed pre/post using the same measure

In a typical ANOVA/t-test, might ask:

- Do those who completed the course have higher self-efficacy compared to those who didn't?
...
- Was the effect of increased self-efficacy resulting from completing the ropes course greater for women compared to men?

- That is an interaction

  - two variables interacting means that the effect of one on an outcome varies as funciton of the other variable
...
The ropes course increases self-efficacy by 15 points for males but only 5 points for females.

In a factorial ANOVA, the interaction is often the most interesting effect because it asks:

> Does the effect of one independent variable depend on the level of another independent variable? ---
